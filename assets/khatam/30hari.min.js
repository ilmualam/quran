...
(function() {
    ...
    if (!isAllowed) {
        console.error('⚠️ Tool ini hanya boleh digunakan di ilmualam.com');
    ...
    function resetProgress() {
        if (confirm('⚠️ Adakah anda pasti nak reset semua progress? Tindakan ini tidak boleh dibatalkan.')) {
            state = {
            ...
            saveState();
            render();
            alert('✅ Progress telah direset. Mulakan journey baru anda!');
        }
    }
    ...
    function checkMilestones() {
        ...
        if (completed === 10 && !state.milestone10) {
            ...
            showCelebration('🎉 Alhamdulillah! 1/3 Journey Completed! 10 Juzuk Done!');
        } else if (completed === 20 && !state.milestone20) {
            state.milestone20 = true;
            showCelebration('🎊 Subhanallah! 2/3 Done! 20 Juzuk! Keep Going Strong!');
        } else if (completed === 30 && !state.milestone30) {
            state.milestone30 = true;
            showCelebration('🏆 ALLAHU AKBAR! KHATAM COMPLETE! 30 JUZUK! May Allah Accept! 🤲');
        }
    }
    ...
    function selectTemplate(template) {
        ...
        if (template === 'custom') {
            ...
            if (days && !isNaN(days) && days > 0 && days <= 365) {
                ...
                alert('⚠️ Sila masukkan nombor yang sah antara 1-365');
    ...
    function shareProgress() {
        ...
        const text = `🕌 Alhamdulillah! Saya telah complete ${completed}/30 juzuk Al-Quran (${percentage}%)!\n\n🎯 Track progress khatam anda di: https://ilmualam.com/jadual-khatam-alquran-30-hari\n\n#KhatamQuran #IlmuAlam`;
        ...
        container.innerHTML = `
            ...
            <div class="khatam-tool ${darkClass}">
                <div class="tool-header">
                    <h2>🕌 Jadual Khatam Al-Quran 30 Hari</h2>
                ...
                <div class="template-selector">
                    <div class="template-btn ${state.selectedTemplate === 'ramadan' ? 'active' : ''}" onclick="window.KhatamTool.selectTemplate('ramadan')">
                        <h3>🌙 Ramadan 30 Hari</h3>
                        <p>1 juzuk/hari<br>Special untuk Ramadan</p>
                    </div>
                ...
                <div class="action-buttons">
                    ...
                    <button class="btn btn-secondary" onclick="window.KhatamTool.toggleDarkMode()">
                        ${state.darkMode ? '☀️' : '🌙'} ${state.darkMode ? 'Light' : 'Dark'} Mode
                    </button>
                ...
                <div style="text-align: center; margin-top: 2rem; padding-top: 2rem; border-top: 1px solid #e0e0e0; color: #666; font-size: 0.9rem;">
                    <p style="margin: 0;">© 2025 IlmuAlam.com | All Rights Reserved</p>
                    <p style="margin: 0.5rem 0 0 0;">Built with ❤️ for the Muslim Ummah</p>
                </div>
            </div>
        `;
    }
